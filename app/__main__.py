...
def create_app(app_container: AppContainer) -> Flask:
    ...
    app.add_url_rule("/pharmacyorders", view_func=PharmacyOrders.as_view("pharmacy_orders", database_service=app_container.database_service, pharmacy_service=app_container.pharmacy_service))
    app.add_url_rule("/pharmacyreport", view_func=PharmacyOrders.as_view("pharmacy_report", database_service=app_container.database_service, pharmacy_service=app_container.pharmacy_service))
    return app
